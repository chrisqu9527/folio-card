...
import { a as Menu, c as Check, i as Play, l as ArrowUpRight, o as Heart, r as Search, s as Copy, t as X, u as ArrowDown } from "../_libs/lucide-react.mjs";
import { n as Route } from "./router-Dmiz9VLS.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { a as DialogOverlay$1, i as DialogDescription$1, n as DialogClose, o as DialogPortal$1, r as DialogContent$1, s as DialogTitle$1, t as Dialog$1 } from "../_libs/@radix-ui/react-dialog+[...].mjs";
import { t as Provider } from "../_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BJNqYfXT.js
...
竖版或方版插画，干净构图，像一套城市观察图鉴中的一页。`
		},
		{
			...
			covers: [
				"/covers/xxd-window.jpg",
				"/covers/xxd-window-b.jpg",
				"/covers/xxd-morning.jpg"
			],
			model: "GPT Image",
			aspect: "4/5",
			featured: true,
...
var creatorById = Object.fromEntries(creators.map((c) => [c.id, c]));
function figureNo(index) {
	return String(index + 1).padStart(2, "0");
}
function countByCreator(id) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				className: "hidden max-w-xs text-right text-sm text-muted sm:block",
				children: "本期从近帖回溯到 2025 冬。点进图鉴可按作者筛出整条时间线。"
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",
			children: creators.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				href: c.url,
				target: "_blank",
				rel: "noreferrer",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: c.name
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "mt-0.5 size-4 text-subtle transition-transform duration-200 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-3 text-[11px] tracking-[0.14em] text-subtle uppercase",
							children: [countByCreator(c.id), " 条图版"]
						})
					]
				})]
			}, c.id))
...
function Hero() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "relative mx-auto max-w-6xl px-4 pt-10 pb-16 sm:px-6 sm:pt-16 sm:pb-24",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-[11px] tracking-[0.28em] text-muted uppercase",
				children: "Vol. 02 — 往期补档 · 2025冬–2026秋"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "mt-6 max-w-4xl font-serif text-[clamp(3.4rem,12vw,8.5rem)] leading-[0.88] tracking-[-0.04em]",
				children: "FOLIO"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-3 font-serif text-[clamp(1.4rem,4vw,2.35rem)] italic text-accent",
				children: "提示词图鉴"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-8 max-w-xl text-base text-muted sm:text-lg",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "一份给创作者用的编辑存档。收录二十位作者时间线上公开分享的图像与视频提示词——近期新作，以及往期可复用的视觉系统。" })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", {
				className: "mt-10 grid max-w-lg grid-cols-3 gap-4 border-y border-border py-5",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
				...
				children: ["进入图鉴", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowDown, { className: "size-4" })]
			})
		]
	});
}
...
}), { name: "folio-favorites" }));
function cn(...inputs) {
	return twMerge(clsx(inputs));
}
function PromptCard({ entry, index, onOpen }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("relative overflow-hidden rounded-lg bg-surface-2 shadow-[var(--shadow-border)] transition-[box-shadow,transform] duration-300 ease-out group-hover:-translate-y-1 group-hover:shadow-[var(--shadow-border-hover)]", entry.aspect === "16/9" && "aspect-video", entry.aspect === "9/16" && (entry.featured ? "aspect-[4/5] sm:aspect-[4/5]" : "aspect-[3/4]"), entry.aspect === "4/5" && "aspect-[4/5]", entry.aspect === "3/4" && "aspect-[3/4]"),
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-fg/0 transition-colors duration-300 group-hover:bg-fg/28" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute inset-x-0 bottom-0 flex items-end justify-between p-4 opacity-0 transition-[opacity,transform] duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100 translate-y-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-[11px] tracking-[0.18em] text-bg uppercase",
							children: "打开图版"
						}), entry.medium === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "flex size-9 items-center justify-center rounded-full bg-bg/90 text-fg",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "size-3.5 fill-current" })
						}) : null]
					}),
					entry.medium === "video" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "absolute top-3 left-3 rounded-full bg-fg/80 px-2.5 py-1 text-[10px] tracking-[0.16em] text-bg uppercase",
						children: "视频"
					}) : null
				]
			})
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						className: "mt-1 font-serif text-xl leading-tight tracking-tight sm:text-2xl",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: cn("size-4", favored && "fill-fg text-fg") })
			})]
		})]
	});
}
...
function DialogOverlay({ className, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay$1, {
		className: cn("fixed inset-0 z-50 bg-fg/70 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className),
		...props
	});
}
function DialogContent({ className, children, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent$1, {
		className: cn("fixed top-1/2 left-1/2 z-50 grid w-[min(1120px,calc(100vw-1.5rem))] max-h-[min(92vh,920px)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-xl bg-surface shadow-[var(--shadow-border-hover)] outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95", className),
		...props,
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogClose, {
			className: "absolute top-3 right-3 z-20 flex size-11 items-center justify-center rounded-full bg-bg/92 text-fg shadow-[var(--shadow-border)] transition-opacity hover:bg-bg focus-visible:ring-2 focus-visible:ring-ring/40",
...
function PromptDetail({ entry, index, open, onOpenChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			className: "grid max-h-[min(92vh,920px)] grid-cols-1 overflow-hidden bg-surface p-0 lg:grid-cols-[minmax(0,1.05fr)_minmax(20rem,0.95fr)]",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative min-h-[42vh] bg-fg lg:min-h-0",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: cover,
					alt: entry.title,
					className: "absolute inset-0 size-full object-contain"
				}), entry.covers.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute bottom-4 left-1/2 flex -translate-x-1/2 gap-2",
					children: entry.covers.map((src, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => setActive(i),
						className: cn("size-2 rounded-full transition-colors", i === active ? "bg-bg" : "bg-bg/40"),
						"aria-label": `图 ${i + 1}`
					}, src))
				}) : null]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex max-h-[min(92vh,920px)] min-h-0 flex-col bg-surface",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "border-b border-border px-5 pt-6 pr-14 pb-4 sm:px-7",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: entry.style }),
									entry.model ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-subtle",
										children: "/"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: entry.model })] }) : null
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-3 flex flex-wrap gap-1.5",
								children: entry.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "min-h-0 flex-1 overflow-y-auto px-5 py-4 sm:px-7",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", {
							className: "font-mono text-[12.5px] leading-relaxed whitespace-pre-wrap text-fg/90",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-2 border-t border-border px-5 py-3 sm:px-7",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "size-4" }), copied ? "已复制" : "复制提示词"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								"aria-label": favored ? "取消收藏" : "收藏",
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: cn("size-4", favored && "fill-fg") })
							}),
...
var Input = import_react.forwardRef(({ className, type, ...props }, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		...
		className: cn("flex h-11 w-full rounded-md bg-surface px-3 py-2 text-sm text-fg shadow-[0_0_0_1px_var(--color-border)] transition-[box-shadow] duration-150 placeholder:text-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/35 disabled:cursor-not-allowed disabled:opacity-50", className),
		ref,
		...props
	});
});
...
function PromptArchive({ selectedId, onSelect }) {
	const [medium, setMedium] = (0, import_react.useState)("all");
	const [tag, setTag] = (0, import_react.useState)(null);
	const [creatorId, setCreatorId] = (0, import_react.useState)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "sticky top-14 z-30 -mx-4 mt-8 border-y border-border bg-bg/90 px-4 py-3 backdrop-blur-md sm:top-16 sm:mx-0 sm:rounded-lg sm:border sm:px-4",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col gap-3 lg:flex-row lg:items-center",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex flex-wrap gap-1.5",
							children: [MEDIUM_FILTERS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => setMedium(item.id),
								className: cn("h-9 rounded-full px-3.5 text-sm transition-colors", medium === item.id ? "bg-fg text-bg" : "text-muted hover:bg-surface-2 hover:text-fg"),
								children: item.label
							}, item.id)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => setOnlyFav((v) => !v),
								className: cn("h-9 rounded-full px-3.5 text-sm transition-colors", onlyFav ? "bg-fg text-bg" : "text-muted hover:bg-surface-2 hover:text-fg"),
								children: "收藏"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: creators.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setCreatorId((cur) => cur === c.id ? null : c.id),
							className: cn("h-8 shrink-0 rounded-full px-3 text-xs transition-colors", creatorId === c.id ? "bg-fg text-bg" : "text-muted shadow-[0_0_0_1px_var(--color-border)] hover:text-fg"),
							children: c.name
						}, c.id))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [TAGS.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("h-8 shrink-0 rounded-full px-3 text-xs transition-colors", tag === t ? "bg-accent text-accent-fg" : "text-muted shadow-[0_0_0_1px_var(--color-border)] hover:text-fg"),
							children: t
						}, t)), (tag || query || onlyFav || medium !== "all" || creatorId) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: () => {
								setTag(null);
								setQuery("");
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "size-3.5" }), "清除"]
						})]
					})
				]
			}),
			filtered.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "换一个标签，或清除筛选后再看。"
				})]
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-8 grid grid-cols-1 gap-x-5 gap-y-10 sm:grid-cols-2 lg:grid-cols-3",
				children: filtered.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptCard, {
					entry,
					index: entries.findIndex((e) => e.id === entry.id),
					onOpen: onSelect
				}, entry.id))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptDetail, {
				entry: selected,
				index: selectedIndex,
				open: Boolean(selected),
				onOpenChange: (next) => {
					if (!next) onSelect(void 0);
				}
			})
		]
	});
...
function SiteFooter() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		id: "colophon",
		className: "border-t border-fg bg-fg text-bg",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-4 max-w-sm text-sm leading-relaxed text-bg/70",
								children: "提示词图鉴是一份持续增补的公开存档。我们从创作者的时间线里整理可复用的视觉系统，保留原帖结构与署名，方便以后不断补充。"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-6 text-[11px] tracking-[0.2em] text-bg/45 uppercase",
								children: "Archive of reusable visual systems"
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "grid gap-10 sm:grid-cols-3 md:col-span-7",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[11px] tracking-[0.2em] text-bg/45 uppercase",
								children: "图鉴"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								className: "mt-4 columns-2 gap-x-6 space-y-2.5 text-sm",
								children: creators.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
										...
										children: [
											"@",
											c.handle,
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowUpRight, { className: "size-3.5 opacity-60" })
										]
									})
								}, c.id))
							})] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								className: "mt-4 space-y-2.5 text-sm text-bg/70",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "悬停阅读图版" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "点击放大与复制" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "按媒介 / 标签筛选" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "本机收藏" })
								]
							})] })
						]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-14 h-px w-full bg-bg/15" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-8 flex flex-col gap-4 text-xs leading-relaxed text-bg/55 sm:flex-row sm:items-end sm:justify-between",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "max-w-xl",
						children: "提示词与配图版权归于原作者。本站只做编辑整理与署名引用，不转售提示词。使用时请保留来源，并遵循各作者在 X 上的分享约定。"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "shrink-0 tracking-[0.14em] uppercase",
						children: "© 2026 FOLIO · Vol. 02"
					})]
				})
			]
		})
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-serif text-xl tracking-tight italic sm:text-2xl",
						children: "FOLIO"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "hidden text-[11px] tracking-[0.22em] text-muted uppercase sm:inline",
						children: "提示词图鉴"
					})]
				}),
			...
			className: cn("overflow-hidden border-t border-border md:hidden", open ? "max-h-48" : "max-h-0"),
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PromptArchive, {
						selectedId: p,
						onSelect: (id) => {
							navigate({
								search: id ? { p: id } : {},
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CreatorsSection, {})
				] }),
